...
class KubernetesExecutorLauncher(
    ...
    private fun agentScript(): String {
        ...
        curl -fsS -X POST -H 'Content-Type: application/json' -d "${dollar}result_payload" "${dollar}EXECUTOR_CONTROL_PLANE_URL/internal/executors/${dollar}EXECUTOR_ID/result-base64" >/dev/null
        """.trimIndent()
    }
}
